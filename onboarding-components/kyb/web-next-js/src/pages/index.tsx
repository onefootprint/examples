...
const publicKey = "pb_test_v8yZ7KpMwCZCAe01dh3bfD";
...
const Demo = () => {
	...
	const handleBusinessDataDone = () => {
		setOption("bo-data");
	};

	const handleBoDataDone = () => {
		setOption("personal-data");
	};

	const handlePersonalDataDone = () => {
		setOption("success");
	};
	...
	return (
		<>
			<Fp.Provider publicKey={publicKey}>
				...
				{isBusinessData && <BusinessData onDone={handleBusinessDataDone} />}
				{isBoData && <BoData onDone={handleBoDataDone} />}
				{isPersonalData && <PersonalData onDone={handlePersonalDataDone} />}
				{isSuccess && <Success />}
			</Fp.Provider>
		</>
	);
	...
	return (
		<Layout>
			<div style={{ marginBottom: 24 }}>
				...
				<Subtitle>Let's get to know your business! 😊</Subtitle>
			</div>
			<Fp.Form onSubmit={handleSubmit}>
				<div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
	...
	return (
		<Layout>
			<div style={{ marginBottom: 24 }}>
				...
				<Subtitle>
					List all individuals who own at least 25% of the business or have
